...
<div class="container">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form:form method="post" class="form-horizontal" servletRelativeAction="/admin/emp/delete" modelAttribute="carrera">
                    <fieldset>
                        <legend class="text-center header"><h2>Eliminar Carrera PFR</h2></h2></legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                               <form:input path="duracion" id="Duracion" name="Duracion" type="text" placeholder="Duracion" class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <form:input path="sede" id="Sede" name="Sede" type="text" placeholder="Sede" class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <form:textarea path="objetivo" class="form-control" id="Objetivo" name="message" placeholder="Ingresar Objetivos" rows="7"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <form:input path="" type="submit" value="Eliminar" class="btn btn-warning btn-lg" />
						<a href="<%=request.getContextPath()%>/admin/emp/list" class="btn btn-danger btn-lg">Cancel</a>
                            </div>
                        </div>
                    </fieldset>
               	</form:form>
