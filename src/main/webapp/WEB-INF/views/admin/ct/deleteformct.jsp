...
<div class="container">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form:form method="post" class="form-horizontal" servletRelativeAction="/admin/ct/delete" modelAttribute="carreraCT">
                    <fieldset>
                        <legend class="text-center header"><h2>Eliminar Carrera Técnica</h2></h2></legend>
